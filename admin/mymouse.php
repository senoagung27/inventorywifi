			...
			<?php	
             ...
             (select * from location_details where dev_status='Dump')
			  ...
			  ?>
				...
				<li class="">			
				    <a href= 'myKeyboard.php<?php echo '?stdev_id='.$get_id; ?>')">WIFI&nbsp;<span class="label label-default"> <?php echo $count;?></span></a>					
				</li>
               ...
               ?>
				<li class="active">			
				    <a href= 'mymouse.php<?php echo '?stdev_id='.$get_id; ?>')">Router&nbsp;<span class="label label-default"> <?php echo $count;?></span></a>					
				</li>				
