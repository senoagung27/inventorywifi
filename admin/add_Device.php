                         ...
                         <div class="alert alert-success"><i class="icon-info-sign"></i> Please Fill in required details</div>						
							<form class="form-horizontal" method="post">											
										...
										<div class="control-group">
											...
											<div class="controls">
											<input type="text" class="span8" name="dev_desc" id="inputPassword" placeholder="SN" required>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
											<input type="text" class="span8" name="dev_brand" id="inputPassword" placeholder="MAC ADDRESS" required>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
											<input type="text" class="span8" name="dev_serial" id="inputPassword" placeholder="TYPE" required>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
											<input type="text" class="span8" name="dev_model" id="inputPassword" placeholder="MERK" required>
											</div>
										</div>
