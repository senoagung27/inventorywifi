 ...
 <br/>
	<div class="pull-left">
			  ...
			  <?php	
               ...
               ?>					
				<li class="">
					<a href="Keyboard.php">WIFI&nbsp;<span class="label label-default"> <?php echo $count;?></span></a>
				</li>
               ...
               ?>
				<li class="active">
				<a href="Mouse.php">Router&nbsp;<span class="label label-default"> <?php echo $count;?></span></a></a>
				</li>
