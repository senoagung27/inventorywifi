 ...
 <br/>
	<div class="pull-left">
			  ...
			  <?php	
               ...
               ?>							
				<li class="">
					<a href="damage_keyboard.php">WIFI&nbsp;<span class="label label-default"> <?php echo $count;?></span></a>
				</li>
			...
			<?php	
               ...
               ?>
				<li class="active">
				<a href="damage_mouse.php">Router&nbsp;<span class="label label-default"> <?php echo $count;?></span></a></a>
				</li>
