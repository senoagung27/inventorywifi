 ...
 <br/>
	<div class="pull-left">
			  ...
			  <?php	
               ...
               ?>					
				<li class="">
					<a href="newKeyboard.php">WIFI&nbsp;<span class="label label-default"> <?php echo $count;?></span></a>
				</li>
			...
			<?php	
	         ...
	         (select * from location_details where stdevice.id = location_details.id)
	          ...
	          ORDER BY stdevice.id DESC");
               ...
               ?>
				<li class="active">
				<a href="newmouse.php">Router&nbsp;<span class="label label-default"> <?php echo $count;?></span></a></a>
				</li>
