...
src="print-list-inventory_files/logo_telkom.png"></span></b></p>

<p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
text-align:center;line-height:normal'><b><span style='font-size:14.0pt;
font-family:"Times New Roman","serif"'>I-TRACKING</span></b></p>

<p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
text-align:center;line-height:normal'><b><span style='font-size:8.0pt;
font-family:"Times New Roman","serif"'>Powered by PT.TELEKOMUNIKASI INDONESIA � 2018</span></b></p><br>
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 normal'><b style='mso-bidi-font-weight:normal'><span style='font-family:"Times New Roman","serif"'>MAC ADDRESS<o:p></o:p></span></b></p>
  ...
  <td width=188 style='width:140.9pt;border:solid windowtext 1.0pt;border-left:mso-border-alt:
  solid windowtext
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes'>
  ...
  padding:0in 5.4pt 0in 5.4pt'>
  <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;height:80;
...
?>
 ...
 <?php	
				...
				where NOT EXISTS 
                (select * from location_details where dev_status='Dump') 
			    and dev_name = 'Router'       and stdev_id = '$get_id' 
				OR NOT EXISTS 
                (select * from location_details where dev_status='Dump') 
				and dev_name = 'router'    and stdev_id = '$get_id'
				OR NOT EXISTS 
                (select * from location_details where dev_status='Dump') 
			    and dev_name = 'ROUTER'     and stdev_id = '$get_id' ")or die(mysql_error());
