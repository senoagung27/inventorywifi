		                    ...
		                    <!-- block -->
		                        <div id="" class="block">
									...
									?>
										...
										<div class="control-group">
											<label class="control-label" for="inputPassword">SN</label>
											<div class="controls">
											<input type="text" class="span8" value="<?php echo $row['dev_desc']; ?>" name="dev_desc" id="inputPassword" placeholder="SN" required>
											</div>
										</div>
										
										
										<div class="control-group">
											<label class="control-label" for="inputPassword">MAC ADDRESS</label>
											<div class="controls">
											<input type="text" class="span8" value="<?php echo $row['dev_serial']; ?>" name="dev_serial" id="inputPassword" placeholder="MAC ADDRESS" required>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
											<input type="text" class="span8" value="<?php echo $row['dev_brand']; ?>" name="dev_brand" id="inputPassword" placeholder="TYPE" required>
											</div>
										</div>

										<div class="control-group">
											<label class="control-label" for="inputPassword">MERK</label>
											<div class="controls">
											<input type="text" class="span8" value="<?php echo $row['dev_model']; ?>" name="dev_model" id="inputPassword" placeholder="MERK" required>
											</div>
										</div>
