    ...
    <body id="home">
        ...
        <!-------------------------------block ------------------------------>
            <div id="block_bg" class="block">
				...
				Router List: <span class="badge badge-info"><?php echo $count_my_device; ?></span>
				</div>
								
           </div>
							
<!-----------------------------------for Print display visible------------------------------------>	
<h4 id="sc">Location:<?php echo $location_row['stdev_location_name']; ?> Router List
			...
			<?php	
             ...
             (select * from location_details where dev_status='Dump')
			  ...
			  ?>
               ...
               ?>				
				<li class="active">			
				    <a href= 'myrouter.php<?php echo '?stdev_id='.$get_id; ?>')">Router&nbsp;<span class="label label-default"> <?php echo $count;?></span></a>					
				</li>
